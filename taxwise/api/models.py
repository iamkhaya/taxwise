...
class Tarriff(models.Model):
    ...
    statistical_unit = models.CharField(max_length=200, null=True)
    general_rate_of_duty = models.CharField(max_length=200, null=True)
    mtf_rate_of_duty = models.CharField(max_length=200, null=True)
